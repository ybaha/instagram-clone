    ...
    <div className="messages-container" ref={messageContainer}>
      ...
      <div style={{ overflowY: "auto", overflowX:"hidden", height: "calc(100% - 95px)"}}>
        <Message
          incoming={true}
          senderImg={img}
          message={"Merhaba Neque porro quisquam est qui dolorem ipsum quia dolor sit amet,"}
        />
        <Message
          incoming={false}
          senderImg={img}
        ...
        <Message
          incoming={true}
          senderImg={img}
          message={"Merhaba Neque porro quisquam est qui dolorem ipsum quia dolor sit ametdolor sit amet,"}
        />
      </div>
    </div>
  )
